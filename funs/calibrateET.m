...
[ptbWindow,winRect] = PsychImaging('OpenWindow', whichScreen, par.BGcolor, [], [], [], [], 4);
...
elseif strcmp(TASK, 'EyeMeasure')
    edfFile = [subjectID, '_Eye.edf'];
else
    edfFile = [subjectID,'_', num2str(BLOCK), '.edf']; % actual task
end
...
try
    ...
    Eyelink('command', ['record_status_message "CDA' num2str(BLOCK) ' EEG"']);
catch
